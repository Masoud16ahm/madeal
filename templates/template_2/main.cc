/*%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-
%                  ma deal                 %
%  Template for Compressible Hyperelastic  % 
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-*/

//! Include the "large_classic" header for elastic large deformation (compressible)
...
int main(){
  ...
  Elastic::Large_classic<dim, p_dim> problem1("inputfile.prm", p_deg);
